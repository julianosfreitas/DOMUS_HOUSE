...
\midrule
\multicolumn{4}{@{}l}{\textit{Meta de custo do arranjo: total de hardware $<$ R\$~200,00 (verificado na BOM datada, Tab.~\ref{tab:bom}).}} \\
\bottomrule
\end{tabular}
\end{table}
...
Tabela~\ref{tab:sus}, representativo do ciclo de uso doméstico, do comissionamento ao
...
datada} --- Tabela~\ref{tab:bom} ---, pois preços de varejo variam no tempo; a data de
