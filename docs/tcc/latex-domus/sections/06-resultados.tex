...
Este capítulo confronta os critérios de sucesso fixados na Seção~\ref{sec:avaliacao}
...
O painel de energia foi implementado e alimentado pela telemetria do Tapo~P110, com um
volume expressivo de leituras acumuladas no banco. Contudo, a avaliação de
