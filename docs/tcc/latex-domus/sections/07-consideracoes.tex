...
pesquisa formulada na Seção~\ref{cap:introducao}, respondem-na separando o que foi
efetivamente demonstrado do que permanece como conjectura, e delimitam as limitações e
os desdobramentos do estudo.
% ATENÇÃO: se o label da introdução não for cap:introducao, ajuste a referência acima.
